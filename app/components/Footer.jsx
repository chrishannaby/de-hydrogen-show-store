...
function FooterMenu({menu, primaryDomainUrl}) {
  ...
  return (
    <nav className="text-darkGray divide-y" role="navigation">
      ...
      <div className="px-5 py-8 flex flex-col sm:flex-row justify-between items-center gap-10 sm:items-end">
        <FooterSubscriptionSection />
        <SocialLinks />
      </div>
      <div className="px-5 py-8 block text-sm font-medium leading-6 text-gray-900">
        <div className="flex items-center justify-between flex-col sm:flex-row gap-6">
          <div className="flex flex-col">
            <div className="text-gray-500 font-normal">Country/region</div>
            <CountrySelector />
          </div>
          <PaymentMethods />
        </div>
...
function CopyrightSection({}) {
  return (
    <div className="text-gray-600 font-normal tracking-wide space-x-1 text-center">
      <small>
        © 2023, <Link to="/">Show Store</Link>
      </small>
      <small>
        <a
          target="_blank"
...
function FooterSubscriptionSection() {
  return (
    <div className="flex flex-col items-center sm:items-start">
      ...
      <div className="relative mt-4 rounded-full shadow-sm w-64 sm:w-full">
        <input
          type="text"
          name="email"
          id="email"
          className="block w-full rounded-full border-0 py-3 pl-5 pr-6 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-500 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6"
          placeholder="Email"
        />
...
function FooterContent({menu, primaryDomainUrl, publicStoreDomain}) {
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-4 mt-6 items-start">
        <div className="grid grid-cols-2 col-span-2 grid-rows-4 gap-4 grid-flow-col">
          {menu.items.map((item) => {
